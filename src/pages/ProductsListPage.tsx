...
const SECTIONS: ReadonlyArray<SectionConfig> = [
  {
    ...
    intro: 'Yeast-derived ingredients for human health-care food, supplements, and functional beverages — selenium yeast and beta glucan with high bioavailability.',
    categoryIds: ['human-nutrition'],
  ...
  },
  {
    ...
    intro: 'Natural savoury and premium yeast extracts for soups, sauces, snacks, plant-based meat, ramen, and gourmet seasoning — including standard, Umami (I+G), and Kokumi specialty grades.',
    categoryIds: ['food-ingredient'],
    certIds: ['iso-22000', 'brc', 'halal', 'kosher'],
  },
  {
    id: 'animal-nutrition',
  ...
  {
    id: 'microbial-nutrition',
    eyebrow: 'Section 004',
    name: 'Microbial Nutrition',
    intro: 'Yeast extracts engineered for industrial fermentation — antibiotic, probiotic, enzyme, vaccine, and recombinant protein production. Continuously-effective and fast-acting options in powder and paste.',
    categoryIds: ['microbial-nutrition'],
    certIds: ['iso-22000', 'brc', 'halal', 'kosher'],
  },
]
