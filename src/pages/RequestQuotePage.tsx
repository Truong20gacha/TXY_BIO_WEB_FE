...
import { SalesPanel } from '@/sections/contact/panels/SalesPanel'
import { SalesForm } from '@/sections/contact/forms/SalesForm'
...
const SEO_TITLE = 'Request a quote · Yeast biotech'
const SEO_DESCRIPTION =
  'Get a complete quotation package within 1 business day — price, lead time, Incoterms, payment terms, and draft contract for your market.'
...
export function RequestQuotePage() {
      ...
      <>
        ...
        <section className="border-t border-line-divider">
          <div className="container-x py-24 md:py-32 text-center">
            <p className="text-eyebrow text-ink-tertiary">QUOTE REQUEST</p>
            ...
            <p className="mt-4 text-body-lg text-ink-secondary max-w-prose mx-auto">
              Browse our catalogue and request a quote for the product you're interested in.
            </p>
            <Link
              to="/products"
  ...
  return (
    <>
      <SEO
        title={`Request a quote for ${product.name} · Yeast biotech`}
      ...
      <nav className="border-t border-line-divider">
        <div className="container-x py-4">
          <div className="flex items-center gap-2 text-caption">
            ...
            <span className="text-line-mid">/</span>
            <span className="text-ink-secondary">Request a quote</span>
          </div>
        </div>
      </nav>
      ...
      <section className="border-t border-line-divider">
        <div className="container-x pt-16 pb-8 md:pt-20 md:pb-12">
          ...
          <p className="mt-4 max-w-prose text-body-lg text-ink-secondary">
            Share details about your operation, target market, and preferred terms.
            Our sales team will respond within 1 business day with price, lead time, and a draft contract for {product.name}.
          </p>
        </div>
      </section>
      ...
      <FadeInSection className="border-t border-line-divider">
        <div className="container-x py-12 md:py-16">
          <CtaPanelLayout
            left={<SalesPanel product={product} />}
            right={<SalesForm product={product} />}
          />
        </div>
      </FadeInSection>
    </>
